# Generated by Django 6.0.2 on 2026-02-12 17:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contract_value', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True, verbose_name='Valor do Contrato')),
                ('spent_value', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True, verbose_name='Valor Gasto')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.CharField(blank=True, default='', max_length=255, verbose_name='Criado Por')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Data de Criação')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Data de Atualização')),
            ],
            options={
